                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-danger">
                                <div class="inner">
                                    ...
                                    <p>Lợi nhuận (ps: đối chiếu công thức bên web cũ)</p>
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header border-0">
                                    <div class="d-flex justify-content-between">
                                        <h4 class="card-title">Thống kê tháng</h4>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header border-0">
                                    <div class="d-flex justify-content-between">
                                        <h4 class="card-title">Thống kê ngày</h4>
                                    </div>
                                </div>
                                <div class="card-body"  style="overflow:auto;">
                                    <div class="position-relative mb-4">
        ...
        <script>
            ...
            const myChartMonth = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: '# TỔNG Bán SP và Sửa chửa {{date("Y")}}',
                        data: dataMonth,
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.2)',
        ...
        <script>
            ...
            const myChartDay = new Chart(ctxDay, {
                ...
                data: {
                    labels: listOfDay,
                    datasets: [{
                        label: '# TỔNG Bán SP và Sửa chửa tháng {{date("m")}}',
                        data: dataDay,
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.2)',
