    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form method="POST" action="congnos/{{$congno->id}}/update" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row ml-0">
                                    <div class="card-body col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="{{$congno->name}}" class="form-control" id="title" placeholder="Nhập tên" />
                                        </div>
                                        <div class="form-group" style="display: none">
                                            <label for=""> {{__('admin.status')}}</label>
                                            <input type="checkbox" name="status" @if ($congno->status == 1) checked @endif data-bootstrap-switch data-off-color="danger" data-on-color="primary">
                                        </div>
                                    </div>
                                </div>
                            </div>
