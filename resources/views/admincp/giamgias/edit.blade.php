    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form method="POST" action="giamgias/{{$giamgia->id}}/update" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row ml-0">
                                    <div class="card-body col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="code" value="{{$giamgia->code}}" class="form-control" id="title" placeholder="Nhập code" />
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label> Giảm giá </label>
                                            <div class="input-group">
                                                <div class="input-group-prepend"> <span class="input-group-text">vnđ</span> </div>
                                                <input type="text" name="giamgia" value="{{old('giamgia',$giamgia->giamgia)}}" class="form-control number" >
                                            </div>
                                        </div>
                                        <div class="form-group" style="display: none">
                                            <label for=""> {{__('admin.status')}}</label>
                                            <input type="checkbox" name="status" @if ($giamgia->status == 1) checked @endif data-bootstrap-switch data-off-color="danger" data-on-color="primary">
                                        </div>
                                    </div>
                                </div>
                            </div>
